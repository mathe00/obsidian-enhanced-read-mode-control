...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"Oletuslukutilatiedostot (Tarkat Polut)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"Tässä luetellut tiedostot avautuvat oletusarvoisesti lukutilassa. Käyttää tarkkaa polkumatchausta.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"Syötä tiedostopolku (esim. Muistiinpanot/OmaTiedosto.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"Oletusarvoiset Vain luku -kansiot (Tarkat polut)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"Kaikki näiden kansioiden (ja alikansioiden) muistiinpanot avautuvat oletusarvoisessa vain luku -tilassa. Käyttää tarkkaa polun vastaavuutta.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"Anna kansion polku (esim. Projektit/Aktiiviset)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"Tiukat Lukutilatiedostot (Tarkat Polut)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"Tässä luetellut tiedostot pakotetaan lukutilaan. Käyttää tarkkaa polkumatchausta.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"Syötä tiedostopolku (esim. Mallit/Suojattu.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"Tiukat Lukutilakansiot (Tarkat Polut)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"Kaikki muistiinpanot näissä kansioissa (ja alikansioissa) pakotetaan tiukkaan lukutilaan. Käyttää tarkkaa polkumatchausta.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"Syötä kansiopolku (esim. Arkisto/2023)",

	// Regex Path List Management
	SETTINGS_ENABLE_REGEX_TITLE: "Ota Regex-matchaus käyttöön (BETA)",
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"Ota käyttöön tiedostopolkujen matchaus säännöllisiin lausekkeisiin. Tämä on BETA-ominaisuus. ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "Käytä varoen: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"virheelliset regex-kuviot voivat aiheuttaa virheitä tai odottamatonta käyttäytymistä. Regex-matchaus tarkistetaan TARKKOJEN kansio-/tiedostomatchausten JÄLKEEN.",

	SETTINGS_DEFAULT_REGEX_TITLE: "Oletuslukutila (Regex-kuviot)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"Tiedostopolut, jotka vastaavat mitä tahansa regex-kuviota tässä, avautuvat oletuslukutilassa. Yksi JavaScript regex-kuvio per rivi (ilman kauttaviivoja).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"Syötä regex-kuvio (esim. ^Päiväkirja/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "Tiukka Lukutila (Regex-kuviot)",
	SETTINGS_STRICT_REGEX_DESC:
		"Tiedostopolut, jotka vastaavat mitä tahansa regex-kuviota tässä, pakotetaan tiukkaan lukutilaan. Yksi JavaScript regex-kuvio per rivi (ilman kauttaviivoja).",
	...
	SETTINGS_LIST_UI_ALREADY_EXISTS_PATH:
		"Polku '{path}' on jo tässä luettelossa.",
	SETTINGS_LIST_UI_ALREADY_EXISTS_REGEX:
		"Regex-malli '{path}' on jo tässä luettelossa.",
	SETTINGS_LIST_UI_INVALID_PATH_OR_REGEX:
		"Virheellinen {itemType}: '{path}'. Tarkista muoto tai olemassaolo.",

	// Behavior Setting
	SETTINGS_FORCE_EDIT_UNMANAGED_TITLE:
		"Pakota Muokkaustila Hallitsemattomille Muistiinpanoille",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_INTRO:
		"Valitse, miten lisäosa käsittelee muistiinpanoja, joita EI ole lueteltu yllä olevissa asetuksissa.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_LABEL: "Ongelma:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT:
		" Navigoitaessa lisäosan hallitsemasta muistiinpanosta (vain luku) normaaliin muistiinpanoon ",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_SAME_TAB:
		"samassa välilehdessä",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_END:
		", Obsidian saattaa virheellisesti jättää normaalin muistiinpanon lukutilaan.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_LABEL:
		"Vaihtoehto 1: POIS KÄYTÖSTÄ (Oletus)",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_LABEL: "Toiminto:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_TEXT:
		" Lisäosa EI KOSKAAN pakota muokkaustilaa normaaleille muistiinpanoille.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_LABEL: "Hyöty:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_TEXT:
		" Kunnioittaa täysin manuaalisia muutoksia. Jos asetat normaalin muistiinpanon vain luku -tilaan, se pysyy sellaisena.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_LABEL: "Haitta:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' "Lukutilaan jumiutuminen" -bugi samassa välilehdessä säilyy. Sinun on manuaalisesti vaihdettava takaisin muokkaustilaan kyseisessä tapauksessa.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" Lisäosa pakottaa KAIKKI normaalit muistiinpanot, jotka löytyvät lukutilasta, takaisin muokkaustilaan avattaessa.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "Hyöty:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' Korjaa "lukutilaan jumiutuminen" -bugin samassa välilehdessä navigoinnissa.',
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_LABEL: "Haitta:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" Ohittaa manuaaliset valinnat. Jos asetat normaalin muistiinpanon vain luku -tilaan, tämä lisäosa PAKOTTAA sen takaisin muokkaustilaan, kun avaat sen uudelleen.",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"Näytä lyhyt ilmoitus, kun lisäosa aktiivisesti muuttaa muistiinpanon näyttötilaa avattaessa. Tämä on BETA-ominaisuus.",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "Ota Vianetsintäloki Käyttöön",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"Näytä yksityiskohtaiset lokit kehittäjäkonsolissa. Vaatii Obsidianin uudelleenkäynnistyksen tai lisäosan uudelleenlatauksen täyden vaikutuksen saavuttamiseksi.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE:
		"Ota käyttöön ristiriitojen tunnistus",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"Analysoi asetukset ristiriitaisten sääntöjen varalta (esim. sama polku oletus- ja tiukoissa luetteloissa). Ristiriidat korostetaan alla olevissa luetteloissa.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "Ilmoita määritysristiriidoista",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"Näytä ilmoitus, jos määritysristiriitoja havaitaan asetuksia avattaessa tai muutettaessa.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: Virheellinen tiukka regex-kuvio: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: Virheellinen oletus regex-kuvio: ",
	NOTICE_NOTIFICATIONS_ENABLED: "Tilanvaihdosta ilmoittaminen käytössä.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"Havaittiin {count} määritysristiriitaa.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"Katso lisätiedot laajennuksen asetuksista.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"Katso lisätiedot alla olevista luetteloista.",

	// Command Palette Command Names (from main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: Vaihda nykyisen muistiinpanon oletuslukutila",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: Vaihda nykyisen muistiinpanon tiukka lukutila",
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"Valitse tämän lisäosan käyttöliittymän näyttökieli. Vaatii Obsidianin uudelleenkäynnistyksen tai lisäosan uudelleenlatauksen muutosten voimaantuloon.",
	SETTINGS_DIAGNOSTICS_TITLE: "Määritysdiagnostiikka",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"Ristiriita: Tämä tiedosto ('{path}') on myös Tiukasti vain luku -tiedostojen luettelossa. Se on TIUKKA.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"Ristiriita: Tämä tiedosto ('{path}') on myös Oletusarvoisesti vain luku -tiedostojen luettelossa. Se on TIUKKA prioriteetin mukaan.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"Ristiriita: Tämä kansio ('{path}') on myös Tiukasti vain luku -kansioiden luettelossa. Kaikki sen sisällä olevat muistiinpanot ovat TIUKKOJA.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"Ristiriita: Tämä kansio ('{path}') on myös Oletusarvoisesti vain luku -kansioiden luettelossa. Kaikki sen sisällä olevat muistiinpanot ovat TIUKKOJA prioriteetin mukaan.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"Ohitus: Tämä tiedosto ('{path}') on oletusluettelossa, mutta se on Tiukka-kansion '{conflictingPath}' sisällä. Se on TIUKKA.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"Info: Tämä tiedosto ('{path}') on Tiukka-luettelossa ja Oletus-kansion '{conflictingPath}' sisällä. Tiedostokohtainen Tiukka-sääntö on etusijalla.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"Tarpeeton: Tämä tiedosto ('{path}') kuuluu jo Oletusarvoisesti vain luku -kansion säännön piiriin kohteelle '{conflictingPath}'.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"Tarpeeton: Tämä tiedosto ('{path}') kuuluu jo Tiukasti vain luku -kansion säännön piiriin kohteelle '{conflictingPath}'.",
};
