...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"ملفات للقراءة فقط افتراضيًا (مسارات دقيقة)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"الملفات المدرجة هنا ستُفتح في وضع القراءة فقط افتراضيًا. يستخدم مطابقة المسار الدقيق.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"أدخل مسار الملف (مثال: ملاحظات/ملفي.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"مجلدات القراءة فقط الافتراضية (مسارات دقيقة)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"سيتم فتح جميع الملاحظات داخل هذه المجلدات (والمجلدات الفرعية) في وضع القراءة فقط الافتراضي. يستخدم مطابقة المسار الدقيق.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"أدخل مسار المجلد (مثال: Projects/Active)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"ملفات للقراءة فقط بشكل صارم (مسارات دقيقة)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"الملفات المدرجة هنا سيتم فرض وضع القراءة فقط عليها. يستخدم مطابقة المسار الدقيق.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"أدخل مسار الملف (مثال: قوالب/محمي.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"مجلدات للقراءة فقط بشكل صارم (مسارات دقيقة)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"جميع الملاحظات داخل هذه المجلدات (والمجلدات الفرعية) سيتم فرض وضع القراءة فقط الصارم عليها. يستخدم مطابقة المسار الدقيق.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"أدخل مسار المجلد (مثال: أرشيف/2023)",
	...
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"تمكين مطابقة مسارات الملفات بالتعبيرات النمطية. هذه ميزة تجريبية (BETA). ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "استخدم بحذر: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"قد تتسبب أنماط التعبير النمطي غير الصالحة في حدوث أخطاء أو سلوك غير متوقع. يتم التحقق من مطابقة التعبير النمطي بعد مطابقة المجلدات/الملفات الدقيقة.",

	SETTINGS_DEFAULT_REGEX_TITLE: "للقراءة فقط افتراضيًا (أنماط Regex)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"مسارات الملفات التي تطابق أي نمط تعبير نمطي هنا ستُفتح في وضع القراءة فقط افتراضيًا. نمط تعبير نمطي JavaScript واحد لكل سطر (بدون شرطات مائلة).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"أدخل نمط Regex (مثال: ^يوميات/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "للقراءة فقط بشكل صارم (أنماط Regex)",
	SETTINGS_STRICT_REGEX_DESC:
		"مسارات الملفات التي تطابق أي نمط تعبير نمطي هنا سيتم فرض وضع القراءة فقط الصارم عليها. نمط تعبير نمطي JavaScript واحد لكل سطر (بدون شرطات مائلة).",
	...
	SETTINGS_LIST_UI_ALREADY_EXISTS_PATH:
		"المسار '{path}' موجود بالفعل في هذه القائمة.",
	SETTINGS_LIST_UI_ALREADY_EXISTS_REGEX:
		"نمط Regex '{path}' موجود بالفعل في هذه القائمة.",
	SETTINGS_LIST_UI_INVALID_PATH_OR_REGEX:
		"{itemType} غير صالح: '{path}'. يرجى التحقق من التنسيق أو الوجود.",

	// إعداد السلوك
	SETTINGS_FORCE_EDIT_UNMANAGED_TITLE:
		"فرض وضع التحرير على الملاحظات غير المُدارة",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_INTRO:
		"اختر كيف يتعامل الملحق مع الملاحظات غير المدرجة في الإعدادات أعلاه.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_LABEL: "المشكلة:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT:
		" عند الانتقال من ملاحظة يتحكم بها الملحق (للقراءة فقط) إلى ملاحظة عادية ",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" الملحق يفرض على أي ملاحظة عادية موجودة في وضع القراءة فقط العودة إلى وضع التحرير عند فتحها.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "الفائدة:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' يصلح خطأ "عالق في وضع القراءة فقط" للتنقل في نفس علامة التبويب.',
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_LABEL: "العيب:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" يتجاوز الاختيارات اليدوية. إذا قمت بتعيين ملاحظة عادية للقراءة فقط، فإن هذا الملحق سيفرض عليها العودة إلى وضع التحرير عند إعادة فتحها.",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"إظهار إشعار موجز عندما يغير الملحق وضع عرض الملاحظة بشكل فعال عند الفتح. هذه ميزة تجريبية (BETA).",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "تمكين تسجيل تصحيح الأخطاء",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"إظهار سجلات مفصلة في وحدة تحكم المطور. يتطلب إعادة تشغيل أوبسيديان أو إعادة تحميل الملحق لتطبيق التأثير بالكامل.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE: "تمكين كشف التعارض",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"تحليل الإعدادات بحثًا عن قواعد متعارضة (مثل نفس المسار في القوائم الافتراضية والصارمة). سيتم تمييز التعارضات في القوائم أدناه.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "الإخطار عند تعارض التكوين",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"إظهار إشعار إذا تم اكتشاف تعارضات في التكوين عند فتح الإعدادات أو تغييرها.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: نمط Regex صارم غير صالح: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: نمط Regex افتراضي غير صالح: ",
	NOTICE_NOTIFICATIONS_ENABLED: "تم تمكين إشعارات تغيير الوضع.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"تم اكتشاف {count} تعارض(ات) في التكوين.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"تحقق من إعدادات البرنامج المساعد للحصول على التفاصيل.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"تحقق من القوائم أدناه للحصول على التفاصيل.",

	// أسماء أوامر لوحة الأوامر (من main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: تبديل القراءة فقط الافتراضية للملاحظة الحالية",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: تبديل القراءة فقط الصارمة للملاحظة الحالية",
	...
	NOTICE_TOGGLE_MOVED_FROM_DEFAULT_SUFFIX:
		" (تمت الإزالة من القائمة الافتراضية)",

	// إعداد اللغة
	SETTINGS_PLUGIN_LANGUAGE_TITLE: "لغة الملحق",
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"اختر لغة العرض لواجهة هذا الملحق. يتطلب إعادة تشغيل أوبسيديان أو إعادة تحميل الملحق لتطبيق التغييرات.",
	SETTINGS_DIAGNOSTICS_TITLE: "تشخيصات التكوين",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"تعارض: هذا الملف ('{path}') موجود أيضًا في قائمة ملفات القراءة فقط الصارمة. سيكون صارمًا.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"تعارض: هذا الملف ('{path}') موجود أيضًا في قائمة ملفات القراءة فقط الافتراضية. سيكون صارمًا حسب الأولوية.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"تعارض: هذا المجلد ('{path}') موجود أيضًا في قائمة مجلدات القراءة فقط الصارمة. ستكون جميع الملاحظات بداخله صارمة.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"تعارض: هذا المجلد ('{path}') موجود أيضًا في قائمة مجلدات القراءة فقط الافتراضية. ستكون جميع الملاحظات بداخله صارمة حسب الأولوية.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"تجاوز: هذا الملف ('{path}') موجود في قائمة افتراضية، ولكنه داخل المجلد الصارم '{conflictingPath}'. سيكون صارمًا.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"معلومة: هذا الملف ('{path}') موجود في قائمة صارمة وداخل المجلد الافتراضي '{conflictingPath}'. قاعدة الملف الصارم لها الأسبقية.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"متكرر: هذا الملف ('{path}') مغطى بالفعل بقاعدة مجلد القراءة فقط الافتراضي لـ '{conflictingPath}'.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"متكرر: هذا الملف ('{path}') مغطى بالفعل بقاعدة مجلد القراءة فقط الصارم لـ '{conflictingPath}'.",
};
