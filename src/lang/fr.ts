...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"Fichiers en Lecture Seule par Défaut (Chemins Exacts)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"Les fichiers listés ici s'ouvriront en mode lecture seule par défaut. Utilise la correspondance exacte de chemin.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"Entrez le chemin du fichier (ex: Notes/MonFichier.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"Dossiers en Lecture Seule par Défaut (Chemins Exacts)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"Toutes les notes dans ces dossiers (et sous-dossiers) s'ouvriront en mode lecture seule par défaut. Utilise la correspondance exacte de chemin.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"Entrez le chemin du dossier (ex: Projets/Actifs)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"Fichiers en Lecture Seule Stricte (Chemins Exacts)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"Les fichiers listés ici seront forcés en mode lecture seule. Utilise la correspondance exacte de chemin.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"Entrez le chemin du fichier (ex: Modèles/Protégé.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"Dossiers en Lecture Seule Stricte (Chemins Exacts)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"Toutes les notes dans ces dossiers (et sous-dossiers) seront forcées en mode lecture seule stricte. Utilise la correspondance exacte de chemin.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"Entrez le chemin du dossier (ex: Archives/2023)",
	...
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"Activer la correspondance des chemins de fichiers avec des expressions régulières. Ceci est une fonctionnalité BÊTA. ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "Utiliser avec prudence : ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"des motifs regex invalides peuvent causer des erreurs ou un comportement inattendu. La correspondance Regex est vérifiée APRÈS les correspondances exactes de dossiers/fichiers.",

	SETTINGS_DEFAULT_REGEX_TITLE: "Lecture Seule par Défaut (Motifs Regex)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"Les chemins de fichiers correspondant à un motif regex ici s'ouvriront en mode lecture seule par défaut. Un motif regex JavaScript par ligne (sans barres obliques).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"Entrez un motif regex (ex: ^Journal/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "Lecture Seule Stricte (Motifs Regex)",
	SETTINGS_STRICT_REGEX_DESC:
		"Les chemins de fichiers correspondant à un motif regex ici seront forcés en mode lecture seule stricte. Un motif regex JavaScript par ligne (sans barres obliques).",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"Entrez un motif regex (ex: ^Modèles/.*)",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' Le bug du "blocage en lecture seule" dans le même onglet persiste. Vous devez manuellement rebasculer en mode édition dans ce cas spécifique.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" Le plugin force TOUTE note normale trouvée en mode lecture seule à repasser en mode édition à son ouverture.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "Avantage :",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' Corrige le bug du "blocage en lecture seule" pour la navigation dans le même onglet.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" Outrepasse les choix manuels. Si vous mettez une note normale en lecture seule, ce plugin LA FORCERA à repasser en mode édition lorsque vous la rouvrirez.",

	// Section Retours & Débogage
	SETTINGS_NOTIFY_ON_MODE_CHANGE_TITLE:
		"Notifier lors du Changement de Mode (BÊTA)",
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"Afficher une brève notification lorsque le plugin change activement le mode de vue d'une note à son ouverture. Ceci est une fonctionnalité BÊTA.",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "Activer le Journal de Débogage",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"Afficher les journaux détaillés dans la console développeur. Nécessite un redémarrage d'Obsidian ou un rechargement du plugin pour prendre pleinement effet.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE:
		"Activer la Détection de Conflits",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"Analyser les paramètres pour des règles conflictuelles (ex: même chemin dans les listes par défaut et strictes). Les conflits seront surlignés dans les listes ci-dessous.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE:
		"Notifier en cas de Conflits de Configuration",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"Afficher une notification si des conflits de configuration sont détectés lors de l'ouverture ou de la modification des paramètres.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode : Motif regex strict invalide : ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode : Motif regex par défaut invalide : ",
	NOTICE_NOTIFICATIONS_ENABLED:
		"Notifications de changement de mode activées.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"{count} conflit(s) de configuration détecté(s).",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"Vérifiez les paramètres du plugin pour les détails.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"Vérifiez les listes ci-dessous pour les détails.",

	// Noms des Commandes de la Palette (depuis main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control : Basculer lecture seule par défaut pour la note actuelle",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control : Basculer lecture seule stricte pour la note actuelle",
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"Choisissez la langue d'affichage pour l'interface de ce plugin. Nécessite un redémarrage d'Obsidian ou un rechargement du plugin pour appliquer les changements.",
	...
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"Conflit : Ce fichier ('{path}') est aussi dans la liste des Fichiers Stricts. Il sera STRICT.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"Conflit : Ce fichier ('{path}') est aussi dans la liste des Fichiers par Défaut. Il sera STRICT (priorité).",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"Conflit : Ce dossier ('{path}') est aussi dans la liste des Dossiers Stricts. Toutes les notes à l'intérieur seront STRICTES.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"Conflit : Ce dossier ('{path}') est aussi dans la liste des Dossiers par Défaut. Toutes les notes à l'intérieur seront STRICTES (priorité).",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"Priorité : Ce fichier ('{path}') est dans une liste par Défaut, mais il est dans le dossier Strict '{conflictingPath}'. Il sera STRICT.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"Info : Ce fichier ('{path}') est dans une liste Stricte et dans le dossier par Défaut '{conflictingPath}'. La règle Stricte du fichier a priorité.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"Redondant : Ce fichier ('{path}') est déjà couvert par la règle du Dossier par Défaut pour '{conflictingPath}'.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"Redondant : Ce fichier ('{path}') est déjà couvert par la règle du Dossier Strict pour '{conflictingPath}'.",
};
