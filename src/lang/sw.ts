...
export default {
    ...
    SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER: 'Weka njia ya faili (k.m., Templates/Iliyolindwa.md)',

    SETTINGS_STRICT_FOLDERS_EXACT_TITLE: 'Folda Kali za Kusoma Pekee (Njia Sahihi)',
    SETTINGS_STRICT_FOLDERS_EXACT_DESC: 'Madokezo yote ndani ya folda hizi (na folda ndogo) yatalazimishwa kuwa katika hali kali ya kusoma pekee. Hutumia ulinganishaji sahihi wa njia.',
    SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER: 'Weka njia ya folda (k.m., Archive/2023)',

    // Regex Path List Management
    SETTINGS_ENABLE_REGEX_TITLE: 'Washa Ulinganishaji wa Regex (BETA)',
    SETTINGS_ENABLE_REGEX_DESC_PART1: 'Washa ulinganishaji wa njia za faili dhidi ya misemo ya kawaida. Hiki ni kipengele cha BETA. ',
    SETTINGS_ENABLE_REGEX_DESC_PART2: 'Tumia kwa tahadhari: ',
    SETTINGS_ENABLE_REGEX_DESC_PART3: 'mifumo batili ya regex inaweza kusababisha hitilafu au mwenendo usiotarajiwa. Ulinganishaji wa Regex huangaliwa BAADA ya ulinganishaji sahihi wa folda/faili.',

    SETTINGS_DEFAULT_REGEX_TITLE: 'Kusoma Pekee Chaguomsingi (Mifumo ya Regex)',
    SETTINGS_DEFAULT_REGEX_DESC: 'Njia za faili zinazolingana na mfumo wowote wa regex hapa zitafunguliwa katika hali chaguo-msingi ya kusoma pekee. Mfumo mmoja wa regex wa JavaScript kwa kila mstari (bila slaishi).',
    SETTINGS_DEFAULT_REGEX_PLACEHOLDER: 'Weka mfumo wa regex (k.m., ^Journal/\\d{4}-\\d{2}-\\d{2}\\.md$)',

    SETTINGS_STRICT_REGEX_TITLE: 'Kusoma Pekee Kali (Mifumo ya Regex)',
    SETTINGS_STRICT_REGEX_DESC: 'Njia za faili zinazolingana na mfumo wowote wa regex hapa zitalazimishwa kuwa katika hali kali ya kusoma pekee. Mfumo mmoja wa regex wa JavaScript kwa kila mstari (bila slaishi).',
    SETTINGS_STRICT_REGEX_PLACEHOLDER: 'Weka mfumo wa regex (k.m., ^Templates/.*)',
    ...
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_INTRO: 'Chagua jinsi programu-jalizi inavyoshughulikia madokezo ambayo HAYAKOorodheshwa katika mipangilio hapo juu.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_LABEL: 'Tatizo:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT: ' Unapopitia kutoka kwa dokezo linalodhibitiwa na programu-jalizi (kusoma pekee) hadi dokezo la kawaida ',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_SAME_TAB: 'katika kichupo kile kile',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_END: ', Obsidian inaweza kuacha dokezo la kawaida likiwa limekwama kimakosa katika hali ya kusoma pekee.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_LABEL: 'Chaguo 1: IMEZIMWA (Chaguomsingi)',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_LABEL: 'Kitendo:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_TEXT: ' Programu-jalizi KAMWE hailazimishi hali ya kuhariri kwenye madokezo ya kawaida.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_LABEL: 'Faida:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_TEXT: ' Inaheshimu kikamilifu mabadiliko ya mikono. Ukiweka dokezo la kawaida kuwa la kusoma pekee, litabaki hivyo.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_LABEL: 'Hasara:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT: ' Hitilafu ya "kukwama katika hali ya kusoma pekee" katika kichupo kile kile hubaki. Lazima urudishe mwenyewe kwa hali ya kuhariri katika kesi hiyo maalum.',
    ...
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT: ' Programu-jalizi inalazimisha DOKEZO LOLOTE la kawaida linalopatikana katika hali ya kusoma pekee kurudi kwenye hali ya kuhariri linapofunguliwa.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: 'Faida:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT: ' Hurekebisha hitilafu ya "kukwama katika hali ya kusoma pekee" kwa urambazaji katika kichupo kile kile.',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_LABEL: 'Hasara:',
    SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT: ' Hubatilisha chaguo za mikono. Ukiweka dokezo la kawaida kuwa la kusoma pekee, programu-jalizi hii ITALILAZIMISHA kurudi kwenye hali ya kuhariri unapofungua tena.',

    // Feedback & Debugging Section
    SETTINGS_NOTIFY_ON_MODE_CHANGE_TITLE: 'Arifu kuhusu Mabadiliko ya Hali (BETA)',
    ...
    COMMAND_TOGGLE_STRICT: "Enhanced Read Mode Control: Geuza kusoma pekee kali kwa dokezo la sasa",

    // Toggle Command Notices (from main.ts)
    NOTICE_TOGGLE_REMOVED_DEFAULT_PREFIX: "Imeondolewa '",
    NOTICE_TOGGLE_REMOVED_DEFAULT_SUFFIX: "' kutoka kwa orodha chaguo-msingi ya kusoma pekee.",
    NOTICE_TOGGLE_ADDED_DEFAULT_PREFIX: "Imeongezwa '",
    NOTICE_TOGGLE_ADDED_DEFAULT_SUFFIX: "' kwenye orodha chaguo-msingi ya kusoma pekee.",
    NOTICE_TOGGLE_REMOVED_STRICT_PREFIX: "Imeondolewa '",
    NOTICE_TOGGLE_REMOVED_STRICT_SUFFIX: "' kutoka kwa orodha kali ya kusoma pekee.",
    NOTICE_TOGGLE_ADDED_STRICT_PREFIX: "Imeongezwa '",
    NOTICE_TOGGLE_ADDED_STRICT_SUFFIX: "' kwenye orodha kali ya kusoma pekee.",
    NOTICE_TOGGLE_MOVED_FROM_STRICT_SUFFIX: " (Imeondolewa kutoka kwa orodha kali)",
    NOTICE_TOGGLE_MOVED_FROM_DEFAULT_SUFFIX: " (Imeondolewa kutoka kwa orodha chaguo-msingi)",
