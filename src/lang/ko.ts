...
export default {
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"이 플러그인 인터페이스의 표시 언어를 선택합니다. 변경 사항을 적용하려면 Obsidian을 다시 시작하거나 플러그인을 다시 로드해야 합니다.",
	SETTINGS_DIAGNOSTICS_TITLE: "구성 진단",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"충돌: 이 파일 ('{path}')은 엄격한 읽기 전용 파일 목록에도 있습니다. 엄격하게 적용됩니다.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"충돌: 이 파일 ('{path}')은 기본 읽기 전용 파일 목록에도 있습니다. 우선 순위에 따라 엄격하게 적용됩니다.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"충돌: 이 폴더 ('{path}')는 엄격한 읽기 전용 폴더 목록에도 있습니다. 내부의 모든 노트는 엄격하게 적용됩니다.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"충돌: 이 폴더 ('{path}')는 기본 읽기 전용 폴더 목록에도 있습니다. 내부의 모든 노트는 우선 순위에 따라 엄격하게 적용됩니다.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"덮어쓰기: 이 파일 ('{path}')은 기본 목록에 있지만 엄격한 폴더 '{conflictingPath}' 내에 있습니다. 엄격하게 적용됩니다.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"정보: 이 파일 ('{path}')은 엄격한 목록에 있으며 기본 폴더 '{conflictingPath}' 내에 있습니다. 파일별 엄격한 규칙이 우선합니다.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"중복: 이 파일 ('{path}')은 이미 '{conflictingPath}'에 대한 기본 읽기 전용 폴더 규칙에 포함됩니다.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"중복: 이 파일 ('{path}')은 이미 '{conflictingPath}'에 대한 엄격한 읽기 전용 폴더 규칙에 포함됩니다.",
};
