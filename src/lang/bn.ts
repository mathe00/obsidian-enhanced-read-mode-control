...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"এখানে তালিকাভুক্ত ফাইলগুলি ডিফল্টভাবে রিড-অনলি মোডে খুলবে। সঠিক পাথ ম্যাচিং ব্যবহার করে।",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"ফাইলের পাথ লিখুন (যেমন, Notes/MyFile.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE: "ডিফল্ট রিড-অনলি ফোল্ডার (সঠিক পাথ)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"এই ফোল্ডারগুলির (এবং সাবফোল্ডারগুলির) মধ্যে থাকা সমস্ত নোট ডিফল্ট রিড-অনলি মোডে খুলবে। সঠিক পাথ ম্যাচিং ব্যবহার করে।",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"ফোল্ডারের পাথ লিখুন (যেমন, Projects/Active)",

	SETTINGS_STRICT_FILES_EXACT_TITLE: "স্ট্রিক্ট রিড-অনলি ফাইল (সঠিক পাথ)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"এখানে তালিকাভুক্ত ফাইলগুলি জোর করে রিড-অনলি মোডে রাখা হবে। সঠিক পাথ ম্যাচিং ব্যবহার করে।",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"ফাইলের পাথ লিখুন (যেমন, Templates/Protected.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"স্ট্রিক্ট রিড-অনলি ফোল্ডার (সঠিক পাথ)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"এই ফোল্ডারগুলির (এবং সাব-ফোল্ডারগুলির) মধ্যে থাকা সমস্ত নোট জোর করে স্ট্রিক্ট রিড-অনলি মোডে রাখা হবে। সঠিক পাথ ম্যাচিং ব্যবহার করে।",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"ফোল্ডারের পাথ লিখুন ( যেমন, Archive/2023)",

	// Regex Path List Management
	SETTINGS_ENABLE_REGEX_TITLE: "রেজেক্স ম্যাচিং সক্রিয় করুন (বিটা)",
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"রেগুলার এক্সপ্রেশনের সাথে ফাইল পাথ ম্যাচিং সক্রিয় করুন। এটি একটি বিটা বৈশিষ্ট্য। ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "সাবধানতার সাথে ব্যবহার করুন: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"অবৈধ রেজেক্স প্যাটার্ন ত্রুটি বা অপ্রত্যাশিত আচরণের কারণ হতে পারে। রেজেক্স ম্যাচিং সঠিক ফোল্ডার/ফাইল ম্যাচের পরে পরীক্ষা করা হয়।",

	SETTINGS_DEFAULT_REGEX_TITLE: "ডিফল্ট রিড-অনলি (রেজেক্স প্যাটার্ন)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"এখানে থাকা যেকোনো রেজেক্স প্যাটার্নের সাথে মিলে যাওয়া ফাইল পাথগুলি ডিফল্ট রিড-অনলি মোডে খুলবে। প্রতি লাইনে একটি জাভাস্ক্রিপ্ট রেজেক্স প্যাটার্ন (স্ল্যাশ ছাড়া)।",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"রেজেক্স প্যাটার্ন লিখুন (যেমন, ^Journal/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "স্ট্রিক্ট রিড-অনলি (রেজেক্স প্যাটার্ন)",
	SETTINGS_STRICT_REGEX_DESC:
		"এখানে থাকা যেকোনো রেজেক্স প্যাটার্নের সাথে মিলে যাওয়া ফাইল পাথগুলি জোর করে স্ট্রিক্ট রিড-অনলি মোডে রাখা হবে। প্রতি লাইনে একটি জাভাস্ক্রিপ্ট রেজেক্স প্যাটার্ন (স্ল্যাশ ছাড়া)।",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"রেজেক্স প্যাটার্ন লিখুন (যেমন, ^Templates/.*)",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' একই ট্যাবে "রিড-অনলিতে আটকে থাকা" বাগটি থেকে যায়। সেক্ষেত্রে আপনাকে ম্যানুয়ালি এডিট মোডে ফিরে যেতে হবে।',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" প্লাগইন রিড-অনলি মোডে পাওয়া যেকোনো সাধারণ নোট খোলার সময় সেটিকে এডিট মোডে ফোর্স করে।",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "সুবিধা:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' একই ট্যাবে নেভিগেশনের জন্য "রিড-অনলিতে আটকে থাকা" বাগটি சரி করে।',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" ম্যানুয়াল পছন্দগুলিকে অগ্রাহ্য করে। আপনি যদি একটি সাধারণ নোটকে রিড-অনলি হিসাবে সেট করেন, এই প্লাগইনটি খোলার সময় সেটিকে এডিট মোডে ফোর্স করবে।",

	// Feedback & Debugging Section
	SETTINGS_NOTIFY_ON_MODE_CHANGE_TITLE:
		"মোড পরিবর্তনের সময় বিজ্ঞপ্তি দিন (বিটা)",
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"প্লাগইন খোলার সময় সক্রিয়ভাবে একটি নোটের ভিউ মোড পরিবর্তন করলে একটি সংক্ষিপ্ত বিজ্ঞপ্তি দেখান। এটি একটি বিটা বৈশিষ্ট্য।",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "ডিবাগ লগিং সক্রিয় করুন",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"ডেভেলপার কনসোলে বিস্তারিত লগ দেখান। সম্পূর্ণ প্রভাবের জন্য অবসিডিয়ান পুনরায় চালু করা বা প্লাগইন পুনরায় লোড করা প্রয়োজন।",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE: "বিরোধ সনাক্তকরণ সক্ষম করুন",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"বিরোধপূর্ণ নিয়মগুলির জন্য সেটিংস বিশ্লেষণ করুন (যেমন ডিফল্ট এবং স্ট্রিক্ট তালিকায় একই পাথ)। বিরোধগুলি নীচের তালিকায় হাইলাইট করা হবে।",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "কনফিগারেশন বিরোধে অবহিত করুন",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"সেটিংস খোলা বা পরিবর্তন করার সময় কনফিগারেশন বিরোধ সনাক্ত করা হলে একটি বিজ্ঞপ্তি দেখান।",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"এনহ্যান্সড রিড মোড: অবৈধ স্ট্রিক্ট রেজেক্স প্যাটার্ন: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"এনহ্যান্সড রিড মোড: অবৈধ ডিফল্ট রেজেক্স প্যাটার্ন: ",
	NOTICE_NOTIFICATIONS_ENABLED:
		"মোড পরিবর্তনের বিজ্ঞপ্তি সক্রিয় করা হয়েছে।",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"{count}টি কনফিগারেশন বিরোধ সনাক্ত করা হয়েছে।",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"বিস্তারিত জানার জন্য প্লাগইন সেটিংস পরীক্ষা করুন।",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"বিস্তারিত জানার জন্য নীচের তালিকাগুলি পরীক্ষা করুন।",

	// Command Palette Command Names (from main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"এনহ্যান্সড রিড মোড কন্ট্রোল: বর্তমান নোটের জন্য ডিফল্ট রিড-অনলি টগল করুন",
	COMMAND_TOGGLE_STRICT:
		"এনহ্যান্সড রিড মোড কন্ট্রোল: বর্তমান নোটের জন্য স্ট্রিক্ট রিড-অনলি টগল করুন",

	// Toggle Command Notices (from main.ts)
	NOTICE_TOGGLE_REMOVED_DEFAULT_PREFIX: "'",
	NOTICE_TOGGLE_REMOVED_DEFAULT_SUFFIX:
		"' ডিফল্ট রিড-অনলি তালিকা থেকে সরানো হয়েছে।",
	NOTICE_TOGGLE_ADDED_DEFAULT_PREFIX: "'",
	NOTICE_TOGGLE_ADDED_DEFAULT_SUFFIX:
		"' ডিফল্ট রিড-অনলি তালিকায় যোগ করা হয়েছে।",
	NOTICE_TOGGLE_REMOVED_STRICT_PREFIX: "'",
	NOTICE_TOGGLE_REMOVED_STRICT_SUFFIX:
		"' স্ট্রিক্ট রিড-অনলি তালিকা থেকে সরানো হয়েছে।",
	NOTICE_TOGGLE_ADDED_STRICT_PREFIX: "'",
	NOTICE_TOGGLE_ADDED_STRICT_SUFFIX:
		"' স্ট্রিক্ট রিড-অনলি তালিকায় যোগ করা হয়েছে।",
	NOTICE_TOGGLE_MOVED_FROM_STRICT_SUFFIX:
		" (স্ট্রিক্ট তালিকা থেকে সরানো হয়েছে)",
	NOTICE_TOGGLE_MOVED_FROM_DEFAULT_SUFFIX:
		" (ডিফল্ট তালিকা থেকে সরানো হয়েছে)",

	// Language Setting
	SETTINGS_PLUGIN_LANGUAGE_TITLE: "প্লাগইন ভাষা",
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"এই প্লাগইনের ইন্টারফেসের জন্য প্রদর্শনের ভাষা চয়ন করুন। পরিবর্তনগুলি প্রয়োগ করতে অবসিডিয়ান পুনরায় চালু করা বা প্লাগইন পুনরায় লোড করা প্রয়োজন।",
	SETTINGS_DIAGNOSTICS_TITLE: "কনফিগারেশন ডায়াগনস্টিকস",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"বিরোধ: এই ফাইলটি ('{path}') স্ট্রিক্ট রিড-অনলি ফাইল তালিকাতেও রয়েছে। এটি স্ট্রিক্ট হবে।",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"বিরোধ: এই ফাইলটি ('{path}') ডিফল্ট রিড-অনলি ফাইল তালিকাতেও রয়েছে। অগ্রাধিকার অনুযায়ী এটি স্ট্রিক্ট হবে।",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"বিরোধ: এই ফোল্ডারটি ('{path}') স্ট্রিক্ট রিড-অনলি ফোল্ডার তালিকাতেও রয়েছে। এর ভিতরের সমস্ত নোট স্ট্রিক্ট হবে।",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"বিরোধ: এই ফোল্ডারটি ('{path}') ডিফল্ট রিড-অনলি ফোল্ডার তালিকাতেও রয়েছে। অগ্রাধিকার অনুযায়ী এর ভিতরের সমস্ত নোট স্ট্রিক্ট হবে।",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"ওভাররাইড: এই ফাইলটি ('{path}') একটি ডিফল্ট তালিকায় রয়েছে, কিন্তু এটি স্ট্রিক্ট ফোল্ডার '{conflictingPath}'-এর ভিতরে। এটি স্ট্রিক্ট হবে।",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"তথ্য: এই ফাইলটি ('{path}') একটি স্ট্রিক্ট তালিকায় রয়েছে এবং ডিফল্ট ফোল্ডার '{conflictingPath}'-এর ভিতরে। ফাইল-নির্দিষ্ট স্ট্রিক্ট নিয়ম অগ্রাধিকার পাবে।",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"অপ্রয়োজনীয়: এই ফাইলটি ('{path}') ইতিমধ্যে '{conflictingPath}'-এর জন্য ডিফল্ট রিড-অনলি ফোল্ডার নিয়ম দ্বারা আচ্ছাদিত।",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"অপ্রয়োজনীয়: এই ফাইলটি ('{path}') ইতিমধ্যে '{conflictingPath}'-এর জন্য স্ট্রিক্ট রিড-অনলি ফোল্ডার নিয়ম দ্বারা আচ্ছাদিত।",
};
