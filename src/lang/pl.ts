...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"Domyślne Pliki Tylko do Odczytu (Dokładne Ścieżki)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"Pliki wymienione tutaj będą domyślnie otwierane w trybie tylko do odczytu. Używa dokładnego dopasowania ścieżki.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"Wprowadź ścieżkę pliku (np. Notatki/MójPlik.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"Domyślne Foldery Tylko do Odczytu (Dokładne Ścieżki)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"Wszystkie notatki w tych folderach (i podfolderach) będą otwierane w domyślnym trybie tylko do odczytu. Używa dokładnego dopasowania ścieżki.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"Wprowadź ścieżkę folderu (np. Projekty/Aktywne)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"Ścisłe Pliki Tylko do Odczytu (Dokładne Ścieżki)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"Pliki wymienione tutaj będą wymuszane w tryb tylko do odczytu. Używa dokładnego dopasowania ścieżki.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"Wprowadź ścieżkę pliku (np. Szablony/Chroniony.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"Ścisłe Foldery Tylko do Odczytu (Dokładne Ścieżki)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"Wszystkie notatki w tych folderach (i podfolderach) będą wymuszane w ścisły tryb tylko do odczytu. Używa dokładnego dopasowania ścieżki.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"Wprowadź ścieżkę folderu (np. Archiwum/2023)",

	// Regex Path List Management
	SETTINGS_ENABLE_REGEX_TITLE: "Włącz Dopasowanie Regex (BETA)",
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"Włącz dopasowywanie ścieżek plików do wyrażeń regularnych. To jest funkcja BETA. ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "Używaj ostrożnie: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"nieprawidłowe wzorce regex mogą powodować błędy lub nieoczekiwane zachowanie. Dopasowanie regex jest sprawdzane PO dokładnych dopasowaniach folderów/plików.",

	SETTINGS_DEFAULT_REGEX_TITLE: "Domyślne Tylko do Odczytu (Wzorce Regex)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"Ścieżki plików pasujące do dowolnego wzorca regex tutaj będą otwierane w domyślnym trybie tylko do odczytu. Jeden wzorzec regex JavaScript na linię (bez ukośników).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"Wprowadź wzorzec regex (np. ^Dziennik/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "Ścisłe Tylko do Odczytu (Wzorce Regex)",
	SETTINGS_STRICT_REGEX_DESC:
		"Ścieżki plików pasujące do dowolnego wzorca regex tutaj będą wymuszane w ścisły tryb tylko do odczytu. Jeden wzorzec regex JavaScript na linię (bez ukośników).",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"Wprowadź wzorzec regex (np. ^Szablony/.*)",
	...
	SETTINGS_LIST_UI_ALREADY_EXISTS_PATH:
		"Ścieżka '{path}' już istnieje na tej liście.",
	SETTINGS_LIST_UI_ALREADY_EXISTS_REGEX:
		"Wzorzec Regex '{path}' już istnieje na tej liście.",
	SETTINGS_LIST_UI_INVALID_PATH_OR_REGEX:
		"Nieprawidłowy {itemType}: '{path}'. Sprawdź format lub istnienie.",

	// Behavior Setting
	SETTINGS_FORCE_EDIT_UNMANAGED_TITLE:
		"Wymuś Tryb Edycji na Niezarządzanych Notatkach",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_INTRO:
		"Wybierz, jak wtyczka ma obsługiwać notatki NIE wymienione w powyższych ustawieniach.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_LABEL: "Problem:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT:
		" Podczas nawigacji z notatki kontrolowanej przez wtyczkę (tylko do odczytu) do normalnej notatki ",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_SAME_TAB:
		"w tej samej karcie",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_END:
		", Obsidian może niepoprawnie pozostawić normalną notatkę w trybie tylko do odczytu.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_LABEL:
		"Opcja 1: WYŁĄCZONE (Domyślnie)",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_LABEL: "Działanie:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_TEXT:
		" Wtyczka NIGDY nie wymusza trybu edycji na normalnych notatkach.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_LABEL: "Korzyść:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_TEXT:
		" W pełni respektuje ręczne zmiany. Jeśli ustawisz normalną notatkę jako tylko do odczytu, tak pozostanie.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_LABEL: "Wada:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' Błąd "zablokowania w trybie tylko do odczytu" w tej samej karcie pozostaje. Musisz ręcznie przełączyć z powrotem do trybu edycji w tym konkretnym przypadku.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" Wtyczka wymusza na KAŻDEJ normalnej notatce znalezionej w trybie tylko do odczytu powrót do trybu edycji przy otwarciu.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "Korzyść:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' Naprawia błąd "zablokowania w trybie tylko do odczytu" dla nawigacji w tej samej karcie.',
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_LABEL: "Wada:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" Zastępuje ręczne wybory. Jeśli ustawisz normalną notatkę jako tylko do odczytu, ta wtyczka WYMUSI jej powrót do trybu edycji przy ponownym otwarciu.",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"Pokaż krótkie powiadomienie, gdy wtyczka aktywnie zmienia tryb widoku notatki przy otwarciu. To jest funkcja BETA.",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "Włącz Logowanie Debugowe",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"Pokaż szczegółowe logi w konsoli deweloperskiej. Wymaga ponownego uruchomienia Obsidian lub przeładowania wtyczki, aby w pełni zadziałało.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE: "Włącz Wykrywanie Konfliktów",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"Analizuj ustawienia pod kątem sprzecznych reguł (np. ta sama ścieżka na listach domyślnych i ścisłych). Konflikty zostaną podświetlone na poniższych listach.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "Powiadamiaj o Konfliktach Konfiguracji",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"Pokaż powiadomienie, jeśli zostaną wykryte konflikty konfiguracji podczas otwierania lub zmiany ustawień.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: Nieprawidłowy ścisły wzorzec regex: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: Nieprawidłowy domyślny wzorzec regex: ",
	NOTICE_NOTIFICATIONS_ENABLED: "Powiadomienia o zmianie trybu włączone.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"Wykryto {count} konflikt(ów) konfiguracji.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"Sprawdź ustawienia wtyczki, aby uzyskać szczegółowe informacje.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"Sprawdź poniższe listy, aby uzyskać szczegółowe informacje.",

	// Command Palette Command Names (from main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: Przełącz domyślne tylko do odczytu dla bieżącej notatki",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: Przełącz ścisłe tylko do odczytu dla bieżącej notatki",

	// Toggle Command Notices (from main.ts)
	NOTICE_TOGGLE_REMOVED_DEFAULT_PREFIX: "Usunięto '",
	NOTICE_TOGGLE_REMOVED_DEFAULT_SUFFIX:
		"' z listy domyślnych tylko do odczytu.",
	NOTICE_TOGGLE_ADDED_DEFAULT_PREFIX: "Dodano '",
	NOTICE_TOGGLE_ADDED_DEFAULT_SUFFIX:
		"' do listy domyślnych tylko do odczytu.",
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"Wybierz język wyświetlania interfejsu tej wtyczki. Wymaga ponownego uruchomienia Obsidian lub przeładowania wtyczki, aby zastosować zmiany.",
	SETTINGS_DIAGNOSTICS_TITLE: "Diagnostyka Konfiguracji",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"Konflikt: Ten plik ('{path}') znajduje się również na liście Plików Ściśle Tylko do Odczytu. Będzie ŚCISŁY.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"Konflikt: Ten plik ('{path}') znajduje się również na liście Plików Domyślnie Tylko do Odczytu. Będzie ŚCISŁY zgodnie z priorytetem.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"Konflikt: Ten folder ('{path}') znajduje się również na liście Folderów Ściśle Tylko do Odczytu. Wszystkie notatki w nim będą ŚCISŁE.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"Konflikt: Ten folder ('{path}') znajduje się również na liście Folderów Domyślnie Tylko do Odczytu. Wszystkie notatki w nim będą ŚCISŁE zgodnie z priorytetem.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"Nadpisanie: Ten plik ('{path}') znajduje się na liście Domyślnej, ale jest wewnątrz folderu Ścisłego '{conflictingPath}'. Będzie ŚCISŁY.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"Info: Ten plik ('{path}') znajduje się na liście Ścisłej i wewnątrz folderu Domyślnego '{conflictingPath}'. Reguła Ścisła specyficzna dla pliku ma pierwszeństwo.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"Redundantne: Ten plik ('{path}') jest już objęty regułą Domyślnego Folderu Tylko do Odczytu для '{conflictingPath}'.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"Redundantne: Ten plik ('{path}') jest już objęty regułą Ścisłego Folderu Tylko do Odczytu dla '{conflictingPath}'.",
};
