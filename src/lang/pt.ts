...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"Arquivos Somente Leitura Padrão (Caminhos Exatos)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"Os arquivos listados aqui serão abertos no modo somente leitura por padrão. Usa correspondência exata de caminho.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"Digite o caminho do arquivo (ex: Notas/MeuArquivo.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"Pastas Somente Leitura Padrão (Caminhos Exatos)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"Todas as notas dentro destas pastas (e subpastas) serão abertas no modo somente leitura padrão. Usa correspondência exata de caminho.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"Digite o caminho da pasta (ex: Projetos/Ativos)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"Arquivos Somente Leitura Estrito (Caminhos Exatos)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"Os arquivos listados aqui serão forçados para o modo somente leitura. Usa correspondência exata de caminho.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"Digite o caminho do arquivo (ex: Modelos/Protegido.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"Pastas Somente Leitura Estrito (Caminhos Exatos)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"Todas as notas nestas pastas (e subpastas) serão forçadas para o modo somente leitura estrito. Usa correspondência exata de caminho.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"Digite o caminho da pasta (ex: Arquivos/2023)",
	...
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"Habilitar a correspondência de caminhos de arquivo com expressões regulares. Esta é uma funcionalidade BETA. ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "Use com cautela: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"padrões regex inválidos podem causar erros ou comportamento inesperado. A correspondência Regex é verificada APÓS as correspondências exatas de pastas/arquivos.",

	SETTINGS_DEFAULT_REGEX_TITLE: "Somente Leitura Padrão (Padrões Regex)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"Caminhos de arquivo que correspondam a qualquer padrão regex aqui serão abertos no modo somente leitura padrão. Um padrão regex JavaScript por linha (sem barras).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"Digite um padrão regex (ex: ^Diario/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "Somente Leitura Estrito (Padrões Regex)",
	SETTINGS_STRICT_REGEX_DESC:
		"Caminhos de arquivo que correspondam a qualquer padrão regex aqui serão forçados para o modo somente leitura estrito. Um padrão regex JavaScript por linha (sem barras).",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"Digite um padrão regex (ex: ^Modelos/.*)",
	...
	SETTINGS_LIST_UI_ALREADY_EXISTS_PATH:
		"O caminho '{path}' já existe nesta lista.",
	SETTINGS_LIST_UI_ALREADY_EXISTS_REGEX:
		"O padrão Regex '{path}' já existe nesta lista.",
	SETTINGS_LIST_UI_INVALID_PATH_OR_REGEX:
		"{itemType} inválido: '{path}'. Verifique o formato ou a existência.",

	// Configuração de Comportamento
	SETTINGS_FORCE_EDIT_UNMANAGED_TITLE:
		"Forçar Modo Edição em Notas Não Gerenciadas",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_INTRO:
		"Escolha como o plugin lida com notas NÃO listadas nas configurações acima.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_LABEL: "Problema:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT:
		" Ao navegar de uma nota controlada pelo plugin (somente leitura) para uma nota normal ",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_SAME_TAB: "na mesma aba",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_PROBLEM_TEXT_END:
		", o Obsidian pode deixar a nota normal incorretamente presa no modo somente leitura.",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_ACTION_TEXT:
		" O plugin NUNCA força o modo edição em notas normais.",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_BENEFIT_TEXT:
		" Respeita totalmente as alterações manuais. Se você definir uma nota normal como somente leitura, ela permanece assim.",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' O bug de "preso em somente leitura" na mesma aba persiste. Você deve voltar manualmente para o modo edição nesse caso específico.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" O plugin força QUALQUER nota normal encontrada no modo somente leitura a voltar para o modo edição ao abri-la.",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' Corrige o bug de "preso em somente leitura" para navegação na mesma aba.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" Sobrescreve escolhas manuais. Se você definir uma nota normal como somente leitura, este plugin A FORÇARÁ a voltar para o modo edição quando você a reabrir.",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"Mostrar uma breve notificação quando o plugin alterar ativamente o modo de visualização de uma nota ao abri-la. Esta é uma funcionalidade BETA.",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "Habilitar Registro de Depuração",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"Mostrar registros detalhados no console do desenvolvedor. Requer reinicialização do Obsidian ou recarregamento do plugin para ter efeito total.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE: "Ativar Detecção de Conflitos",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"Analisar configurações para regras conflitantes (ex: mesmo caminho nas listas padrão e estrita). Os conflitos serão destacados nas listas abaixo.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE:
		"Notificar sobre Conflitos de Configuração",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"Mostrar uma notificação se conflitos de configuração forem detectados ao abrir ou alterar as configurações.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: Padrão regex estrito inválido: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: Padrão regex padrão inválido: ",
	NOTICE_NOTIFICATIONS_ENABLED:
		"Notificações de mudança de modo habilitadas.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"{count} conflito(s) de configuração detectado(s).",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"Verifique as configurações do plugin para obter detalhes.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"Verifique as listas abaixo para obter detalhes.",

	// Nomes de Comando da Paleta de Comandos (de main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: Alternar somente leitura padrão para nota atual",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: Alternar somente leitura estrito para nota atual",
	...
	NOTICE_TOGGLE_REMOVED_DEFAULT_SUFFIX:
		"' da lista de somente leitura padrão.",
	...
	NOTICE_TOGGLE_REMOVED_STRICT_SUFFIX:
		"' da lista de somente leitura estrito.",
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"Escolha o idioma de exibição para a interface deste plugin. Requer reinicialização do Obsidian ou recarregamento do plugin para aplicar as alterações.",
	SETTINGS_DIAGNOSTICS_TITLE: "Diagnóstico de Configuração",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"Conflito: Este arquivo ('{path}') também está na lista de Arquivos Somente Leitura Estritos. Será ESTRITO.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"Conflito: Este arquivo ('{path}') também está na lista de Arquivos Somente Leitura Padrão. Será ESTRITO conforme a prioridade.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"Conflito: Esta pasta ('{path}') também está na lista de Pastas Somente Leitura Estritas. Todas as notas dentro serão ESTRITAS.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"Conflito: Esta pasta ('{path}') também está na lista de Pastas Somente Leitura Padrão. Todas as notas dentro serão ESTRITAS conforme a prioridade.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"Substituição: Este arquivo ('{path}') está em uma lista Padrão, mas está dentro da pasta Estrita '{conflictingPath}'. Será ESTRITO.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"Info: Este arquivo ('{path}') está em uma lista Estrita e dentro da pasta Padrão '{conflictingPath}'. A regra Estrita específica do arquivo tem precedência.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"Redundante: Este arquivo ('{path}') já está coberto pela regra de Pasta Somente Leitura Padrão para '{conflictingPath}'.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"Redundante: Este arquivo ('{path}') já está coberto pela regra de Pasta Somente Leitura Estrita para '{conflictingPath}'.",
};
