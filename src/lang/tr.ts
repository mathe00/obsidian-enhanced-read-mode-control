...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"Varsayılan Salt Okunur Dosyalar (Tam Yollar)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"Burada listelenen dosyalar varsayılan olarak salt okunur modda açılır. Tam yol eşleşmesini kullanır.",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"Dosya yolunu girin (örn: Notlar/Dosyam.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"Varsayılan Salt Okunur Klasörler (Tam Yollar)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"Bu klasörlerdeki (ve alt klasörlerdeki) tüm notlar varsayılan salt okunur modda açılacaktır. Tam yol eşleştirmesi kullanır.",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"Klasör yolunu girin (örn. Projeler/Aktif)",

	SETTINGS_STRICT_FILES_EXACT_TITLE: "Katı Salt Okunur Dosyalar (Tam Yollar)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"Burada listelenen dosyalar salt okunur moda zorlanır. Tam yol eşleşmesini kullanır.",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"Dosya yolunu girin (örn: Şablonlar/Korumalı.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"Katı Salt Okunur Klasörler (Tam Yollar)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"Bu klasörlerdeki (ve alt klasörlerindeki) tüm notlar katı salt okunur moda zorlanır. Tam yol eşleşmesini kullanır.",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"Klasör yolunu girin (örn: Arşiv/2023)",

	// Regex Path List Management
	SETTINGS_ENABLE_REGEX_TITLE: "Regex Eşleşmesini Etkinleştir (BETA)",
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"Dosya yollarının düzenli ifadelerle eşleşmesini etkinleştirin. Bu bir BETA özelliğidir. ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "Dikkatli kullanın: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"geçersiz regex desenleri hatalara veya beklenmedik davranışlara neden olabilir. Regex eşleşmesi, tam klasör/dosya eşleşmelerinden SONRA kontrol edilir.",

	SETTINGS_DEFAULT_REGEX_TITLE: "Varsayılan Salt Okunur (Regex Desenleri)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"Buradaki herhangi bir regex deseniyle eşleşen dosya yolları varsayılan olarak salt okunur modda açılır. Satır başına bir JavaScript regex deseni (eğik çizgi olmadan).",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"Regex desenini girin (örn: ^Günlük/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "Katı Salt Okunur (Regex Desenleri)",
	SETTINGS_STRICT_REGEX_DESC:
		"Buradaki herhangi bir regex deseniyle eşleşen dosya yolları katı salt okunur moda zorlanır. Satır başına bir JavaScript regex deseni (eğik çizgi olmadan).",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"Regex desenini girin (örn: ^Şablonlar/.*)",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION1_DRAWBACK_TEXT:
		' Aynı sekmedeki "salt okunur modda takılı kalma" hatası devam eder. Bu özel durumda manuel olarak düzenleme moduna geri dönmeniz gerekir.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" Eklenti, salt okunur modda bulunan HERHANGİ bir normal notu açarken düzenleme moduna geri zorlar.",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "Fayda:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' Aynı sekme gezinmesi için "salt okunur modda takılı kalma" hatasını düzeltir.',
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" Manuel seçimleri geçersiz kılar. Normal bir notu salt okunur olarak ayarlarsanız, bu eklenti yeniden açtığınızda onu düzenleme moduna geri ZORLAR.",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"Eklenti bir notun görünüm modunu açarken aktif olarak değiştirdiğinde kısa bir bildirim gösterin. Bu bir BETA özelliğidir.",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "Hata Ayıklama Günlüğünü Etkinleştir",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"Geliştirici konsolunda ayrıntılı günlükleri gösterin. Tamamen etkili olması için Obsidian'ı yeniden başlatmak veya eklentiyi yeniden yüklemek gerekir.",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE: "Çakışma Algılamayı Etkinleştir",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"Çakışan kurallar için ayarları analiz edin (ör. varsayılan ve katı listelerde aynı yol). Çakışmalar aşağıdaki listelerde vurgulanacaktır.",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "Yapılandırma Çakışmalarında Bildir",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"Ayarlar açıldığında veya değiştirildiğinde yapılandırma çakışmaları algılanırsa bir bildirim gösterin.",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: Geçersiz katı regex deseni: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: Geçersiz varsayılan regex deseni: ",
	NOTICE_NOTIFICATIONS_ENABLED:
		"Mod değişikliği bildirimleri etkinleştirildi.",
	NOTICE_CONFLICTS_DETECTED_SUMMARY:
		"{count} yapılandırma çakışması algılandı.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"Ayrıntılar için eklenti ayarlarını kontrol edin.",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"Ayrıntılar için aşağıdaki listeleri kontrol edin.",

	// Command Palette Command Names (from main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: Geçerli not için varsayılan salt okunurluğu değiştir",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: Geçerli not için katı salt okunurluğu değiştir",

	// Toggle Command Notices (from main.ts)
	NOTICE_TOGGLE_REMOVED_DEFAULT_PREFIX: "'",
	NOTICE_TOGGLE_REMOVED_DEFAULT_SUFFIX:
		"' varsayılan salt okunur listesinden kaldırıldı.",
	NOTICE_TOGGLE_ADDED_DEFAULT_PREFIX: "'",
	NOTICE_TOGGLE_ADDED_DEFAULT_SUFFIX:
		"' varsayılan salt okunur listesine eklendi.",
	NOTICE_TOGGLE_REMOVED_STRICT_PREFIX: "'",
	NOTICE_TOGGLE_REMOVED_STRICT_SUFFIX:
		"' katı salt okunur listesinden kaldırıldı.",
	...
	NOTICE_TOGGLE_MOVED_FROM_DEFAULT_SUFFIX:
		" (varsayılan listeden kaldırıldı)",

	// Language Setting
	SETTINGS_PLUGIN_LANGUAGE_TITLE: "Eklenti Dili",
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"Bu eklenti arayüzü için görüntüleme dilini seçin. Değişikliklerin uygulanması için Obsidian'ı yeniden başlatmak veya eklentiyi yeniden yüklemek gerekir.",
	SETTINGS_DIAGNOSTICS_TITLE: "Yapılandırma Tanıları",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"Çakışma: Bu dosya ('{path}') aynı zamanda Katı Salt Okunur Dosyalar listesinde. KATI olacak.",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"Çakışma: Bu dosya ('{path}') aynı zamanda Varsayılan Salt Okunur Dosyalar listesinde. Önceliğe göre KATI olacak.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"Çakışma: Bu klasör ('{path}') aynı zamanda Katı Salt Okunur Klasörler listesinde. İçindeki tüm notlar KATI olacak.",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"Çakışma: Bu klasör ('{path}') aynı zamanda Varsayılan Salt Okunur Klasörler listesinde. İçindeki tüm notlar önceliğe göre KATI olacak.",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"Geçersiz Kılma: Bu dosya ('{path}') bir Varsayılan listede, ancak Katı klasör '{conflictingPath}' içinde. KATI olacak.",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"Bilgi: Bu dosya ('{path}') bir Katı listede ve Varsayılan '{conflictingPath}' klasörünün içinde. Dosyaya özgü Katı kural önceliklidir.",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"Gereksiz: Bu dosya ('{path}') zaten '{conflictingPath}' için Varsayılan Salt Okunur Klasör kuralı kapsamında.",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"Gereksiz: Bu dosya ('{path}') zaten '{conflictingPath}' için Katı Salt Okunur Klasör kuralı kapsamında.",
};
