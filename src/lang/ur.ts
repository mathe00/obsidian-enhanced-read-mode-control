...
export default {
	...
	SETTINGS_DEFAULT_FILES_EXACT_TITLE:
		"ڈیفالٹ صرف پڑھنے والی فائلیں (عین مطابق پاتھ)",
	SETTINGS_DEFAULT_FILES_EXACT_DESC:
		"یہاں درج فائلیں بطور ڈیفالٹ صرف پڑھنے کے موڈ میں کھلیں گی۔ عین مطابق پاتھ میچنگ استعمال ہوتی ہے۔",
	SETTINGS_DEFAULT_FILES_EXACT_PLACEHOLDER:
		"فائل کا پاتھ درج کریں (مثال کے طور پر: Notes/MyFile.md)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_TITLE:
		"ڈیفالٹ صرف پڑھنے کے لیے فولڈرز (عین راستے)",
	SETTINGS_DEFAULT_FOLDERS_EXACT_DESC:
		"ان فولڈرز (اور ذیلی فولڈرز) کے اندر تمام نوٹس ڈیفالٹ صرف پڑھنے کے موڈ میں کھلیں گے۔ عین مطابق راستے کی مماثلت کا استعمال کرتا ہے۔",
	SETTINGS_DEFAULT_FOLDERS_EXACT_PLACEHOLDER:
		"فولڈر کا راستہ درج کریں (مثلاً، Projects/Active)",

	SETTINGS_STRICT_FILES_EXACT_TITLE:
		"سخت صرف پڑھنے والی فائلیں (عین مطابق پاتھ)",
	SETTINGS_STRICT_FILES_EXACT_DESC:
		"یہاں درج فائلیں صرف پڑھنے کے موڈ پر مجبور کی جائیں گی۔ عین مطابق پاتھ میچنگ استعمال ہوتی ہے۔",
	SETTINGS_STRICT_FILES_EXACT_PLACEHOLDER:
		"فائل کا پاتھ درج کریں (مثال کے طور پر: Templates/Protected.md)",

	SETTINGS_STRICT_FOLDERS_EXACT_TITLE:
		"سخت صرف پڑھنے والے فولڈرز (عین مطابق پاتھ)",
	SETTINGS_STRICT_FOLDERS_EXACT_DESC:
		"ان فولڈرز (اور ذیلی فولڈرز) میں موجود تمام نوٹس سخت صرف پڑھنے کے موڈ پر مجبور کیے جائیں گے۔ عین مطابق پاتھ میچنگ استعمال ہوتی ہے۔",
	SETTINGS_STRICT_FOLDERS_EXACT_PLACEHOLDER:
		"فولڈر کا پاتھ درج کریں (مثال کے طور پر: Archive/2023)",

	// Regex Path List Management
	SETTINGS_ENABLE_REGEX_TITLE: "ریجیکس میچنگ فعال کریں (بیٹا)",
	SETTINGS_ENABLE_REGEX_DESC_PART1:
		"فائل پاتھ کو ریگولر ایکسپریشنز کے خلاف میچنگ فعال کریں۔ یہ ایک بیٹا فیچر ہے۔ ",
	SETTINGS_ENABLE_REGEX_DESC_PART2: "احتیاط سے استعمال کریں: ",
	SETTINGS_ENABLE_REGEX_DESC_PART3:
		"غلط ریجیکس پیٹرن غلطیاں یا غیر متوقع رویے کا سبب بن سکتے ہیں۔ ریجیکس میچنگ عین مطابق فولڈر/فائل میچز کے بعد چیک کی جاتی ہے۔",

	SETTINGS_DEFAULT_REGEX_TITLE: "ڈیفالٹ صرف پڑھنے والے (ریجیکس پیٹرنز)",
	SETTINGS_DEFAULT_REGEX_DESC:
		"یہاں کسی بھی ریجیکس پیٹرن سے مماثل فائل پاتھ ڈیفالٹ صرف پڑھنے کے موڈ میں کھلیں گے۔ فی لائن ایک جاوا اسکرپٹ ریجیکس پیٹرن (سلیش کے بغیر)۔",
	SETTINGS_DEFAULT_REGEX_PLACEHOLDER:
		"ریجیکس پیٹرن درج کریں (مثال کے طور پر: ^Journal/\\d{4}-\\d{2}-\\d{2}\\.md$)",

	SETTINGS_STRICT_REGEX_TITLE: "سخت صرف پڑھنے والے (ریجیکس پیٹرنز)",
	SETTINGS_STRICT_REGEX_DESC:
		"یہاں کسی بھی ریجیکس پیٹرن سے مماثل فائل پاتھ سخت صرف پڑھنے کے موڈ پر مجبور کیے جائیں گے۔ فی لائن ایک جاوا اسکرپٹ ریجیکس پیٹرن (سلیش کے بغیر)۔",
	SETTINGS_STRICT_REGEX_PLACEHOLDER:
		"ریجیکس پیٹرن درج کریں (مثال کے طور پر: ^Templates/.*)",
	...
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_ACTION_TEXT:
		" پلگ ان کسی بھی عام نوٹ کو جو صرف پڑھنے کے موڈ میں پایا جاتا ہے، کھولنے پر ایڈیٹ موڈ پر واپس مجبور کرتا ہے۔",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_LABEL: "فائدہ:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_BENEFIT_TEXT:
		' اسی ٹیب میں نیویگیشن کے لیے "صرف پڑھنے کے موڈ میں پھنس جانے" کا بگ ٹھیک کرتا ہے۔',
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_LABEL: "نقصان:",
	SETTINGS_FORCE_EDIT_UNMANAGED_DESC_OPTION2_DRAWBACK_TEXT:
		" دستی انتخاب کو اوور رائڈ کرتا ہے۔ اگر آپ کسی عام نوٹ کو صرف پڑھنے کے لیے سیٹ کرتے ہیں، تو یہ پلگ ان اسے دوبارہ کھولنے پر ایڈیٹ موڈ پر واپس مجبور کرے گا۔",
	...
	SETTINGS_NOTIFY_ON_MODE_CHANGE_DESC:
		"جب پلگ ان کسی نوٹ کا ویو موڈ کھولنے پر فعال طور پر تبدیل کرتا ہے تو ایک مختصر اطلاع دکھائیں۔ یہ ایک بیٹا فیچر ہے۔",
	SETTINGS_ENABLE_DEBUG_LOGGING_TITLE: "ڈیبگ لاگنگ فعال کریں",
	SETTINGS_ENABLE_DEBUG_LOGGING_DESC:
		"ڈیولپر کنسول میں تفصیلی لاگز دکھائیں۔ مکمل اثر کے لیے آبسیڈین کو دوبارہ شروع کرنے یا پلگ ان کو دوبارہ لوڈ کرنے کی ضرورت ہے۔",
	SETTINGS_ENABLE_CONFLICT_DETECTION_TITLE:
		"تنازعہ کا پتہ لگانے کو فعال کریں",
	SETTINGS_ENABLE_CONFLICT_DETECTION_DESC:
		"متضاد اصول کے لیے ترتیبات کا تجزیہ کریں (مثلاً ڈیفالٹ اور سخت فہرستوں میں ایک ہی راستہ)۔ تنازعات کو نیچے دی گئی فہرستوں میں نمایاں کیا جائے گا۔",
	SETTINGS_NOTIFY_ON_CONFLICT_TITLE: "کنفیگریشن تنازعات پر مطلع کریں",
	SETTINGS_NOTIFY_ON_CONFLICT_DESC:
		"اگر ترتیبات کھولتے یا تبدیل کرتے وقت کنفیگریشن تنازعات کا پتہ چلتا ہے تو ایک اطلاع دکھائیں۔",
	...
	NOTICE_INVALID_STRICT_REGEX_PREFIX:
		"Enhanced Read Mode: غلط سخت ریجیکس پیٹرن: ",
	NOTICE_INVALID_DEFAULT_REGEX_PREFIX:
		"Enhanced Read Mode: غلط ڈیفالٹ ریجیکس پیٹرن: ",
	...
	NOTICE_CHECK_SETTINGS_FOR_DETAILS:
		"تفصیلات کے لیے پلگ ان کی ترتیبات چیک کریں۔",
	NOTICE_CHECK_SETTINGS_FOR_DETAILS_INLINE:
		"تفصیلات کے لیے نیچے دی گئی فہرستیں چیک کریں۔",

	// Command Palette Command Names (from main.ts)
	COMMAND_TOGGLE_DEFAULT:
		"Enhanced Read Mode Control: موجودہ نوٹ کے لیے ڈیفالٹ صرف پڑھنے والا ٹوگل کریں",
	COMMAND_TOGGLE_STRICT:
		"Enhanced Read Mode Control: موجودہ نوٹ کے لیے سخت صرف پڑھنے والا ٹوگل کریں",
	...
	SETTINGS_PLUGIN_LANGUAGE_DESC:
		"اس پلگ ان کے انٹرفیس کے لیے ڈسپلے زبان منتخب کریں۔ تبدیلیوں کو لاگو کرنے کے لیے آبسیڈین کو دوبارہ شروع کرنے یا پلگ ان کو دوبارہ لوڈ کرنے کی ضرورت ہے۔",
	SETTINGS_DIAGNOSTICS_TITLE: "کنفیگریشن تشخیصات",
	CONFLICT_DIRECT_SAME_PATH_FILE_DEFAULT:
		"تصادم: یہ فائل ('{path}') سخت صرف پڑھنے والی فائلوں کی فہرست میں بھی ہے۔ یہ سخت ہوگی۔",
	CONFLICT_DIRECT_SAME_PATH_FILE_STRICT:
		"تصادم: یہ فائل ('{path}') ڈیفالٹ صرف پڑھنے والی فائلوں کی فہرست میں بھی ہے۔ یہ ترجیح کے مطابق سخت ہوگی۔",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_DEFAULT:
		"تصادم: یہ فولڈر ('{path}') سخت صرف پڑھنے والے فولڈرز کی فہرست میں بھی ہے۔ اس کے اندر تمام نوٹس سخت ہوں گے۔",
	CONFLICT_DIRECT_SAME_PATH_FOLDER_STRICT:
		"تصادم: یہ فولڈر ('{path}') ڈیفالٹ صرف پڑھنے والے فولڈرز کی فہرست میں بھی ہے۔ اس کے اندر تمام نوٹس ترجیح کے مطابق سخت ہوں گے۔",
	CONFLICT_DEFAULT_FILE_IN_STRICT_FOLDER:
		"اوور رائڈ: یہ فائل ('{path}') ڈیفالٹ فہرست میں ہے، لیکن یہ سخت فولڈر '{conflictingPath}' کے اندر ہے۔ یہ سخت ہوگی۔",
	CONFLICT_STRICT_FILE_IN_DEFAULT_FOLDER:
		"معلومات: یہ فائل ('{path}') سخت فہرست میں ہے اور ڈیفالٹ فولڈر '{conflictingPath}' کے اندر ہے۔ فائل کے لیے مخصوص سخت اصول کو ترجیح حاصل ہے۔",
	CONFLICT_DEFAULT_FILE_IN_DEFAULT_FOLDER_REDUNDANT:
		"غیر ضروری: یہ فائل ('{path}') پہلے ہی '{conflictingPath}' کے لیے ڈیفالٹ صرف پڑھنے والے فولڈر کے اصول کے تحت آتی ہے۔",
	CONFLICT_STRICT_FILE_IN_STRICT_FOLDER_REDUNDANT:
		"غیر ضروری: یہ فائل ('{path}') پہلے ہی '{conflictingPath}' کے لیے سخت صرف پڑھنے والے فولڈر کے اصول کے تحت آتی ہے۔",
};
